...
export default function Testimonials() {
  ...
  const testimonialsSection = homeContent?.testimonialsSection || {};
      ...
      <div className="container">
        <div className="section-title text-center">
          <h6 className="sub-title wow fadeInUp">
            <img src="/assets/img/home-1/star.svg" alt="img" /> {testimonialsSection.eyebrow}
          </h6>
          <h2 className="tx-title sec_title tz-itm-title tz-itm-anim">
            {testimonialsSection.title} <br /> <span>{testimonialsSection.titleHighlight}</span>
          </h2>
        </div>
